...
import * as core_1 from '@angular-devkit/core';
import * as schematics_1 from '@angular-devkit/schematics';
import * as ts from 'typescript';
import * as ast_utils_1 from '@schematics/angular/utility/ast-utils';
import * as change_1 from '@schematics/angular/utility/change';
import * as find_module_1 from '@schematics/angular/utility/find-module';
import * as lint_fix_1 from '@schematics/angular/utility/lint-fix';
...
import * as validation_1 from '@schematics/angular/utility/validation';

function readIntoSourceFile(host: any, modulePath: any) {
...
export default function(options: ComponentSchema): Rule {
    return (host: Tree) => {
        ...
        const templateSource = schematics_1.apply(schematics_1.url('./files'), [
            ...
            schematics_1.template(Object.assign({}, core_1.strings, { 'if-flat': (s: any) => options.flat ? '' : s }, options)),
